        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="cart-action text-end">
                    ...
                    <a class="btn btn-rounded"><i class="far fa-cart-plus mr-5"></i>Continue Shopping</a>
                </div>
                ...
                <div class="row mb-50">
                    <div class="col-lg-6 col-md-12">
                        ...
                        <form class="field_form shipping_calculator">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-12">
                                    <button class="btn btn-rounded btn-sm"><i class="far fa-retweet mr-5"></i>Update</button>
                                </div>
                            </div>
                        </form>
