...
<div class="content-header">
    ...
    <div>
        ...
        <a href="<?= base_url() ?>/finance/tambahproduk" class="btn btn-primary btn-sm rounded">Create new</a>
    </div>
</div>
<div class="card mb-4">
        ...
        <article class="itemlist">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                    <a class="itemside" href="#">
                        <div class="left">
                            <img src="<?= base_url() ?>/backend/imgs/items/2.jpg" class="img-sm img-thumbnail" alt="Item">
                        </div>
                        <div class="info">
        ...
        <article class="itemlist">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                    <a class="itemside" href="#">
                        <div class="left">
                            <img src="<?= base_url() ?>/backend/imgs/items/3.jpg" class="img-sm img-thumbnail" alt="Item">
                        </div>
                        <div class="info">
        ...
        <article class="itemlist">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                    <a class="itemside" href="#">
                        <div class="left">
                            <img src="<?= base_url() ?>/backend/imgs/items/4.jpg" class="img-sm img-thumbnail" alt="Item">
                        </div>
                        <div class="info">
        ...
        <article class="itemlist">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                    <a class="itemside" href="#">
                        <div class="left">
                            <img src="<?= base_url() ?>/backend/imgs/items/5.jpg" class="img-sm img-thumbnail" alt="Item">
                        </div>
                        <div class="info">
        ...
        <article class="itemlist">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                    <a class="itemside" href="#">
                        <div class="left">
                            <img src="<?= base_url() ?>/backend/imgs/items/6.jpg" class="img-sm img-thumbnail" alt="Item">
                        </div>
                        <div class="info">
